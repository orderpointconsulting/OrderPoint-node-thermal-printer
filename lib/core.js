...
class ThermalPrinter {
  ...
  setTypeFontC() {
    this.append(this.printer.config.TXT_FONT_C);
  }


  setTypeFontD() {
    this.append(this.printer.config.TXT_FONT_D);
  }

  setTypeFontE() {
    this.append(this.printer.config.TXT_FONT_E);
  }
  ...
  setTextDouble() {
    this.append(this.printer.setTextDouble());
  }
  ...
  setTextColorToBlack(){
    this.append(this.printer.config.TXT_BLACK);
  }

  setTextColorToRed(){
    this.append(this.printer.config.TXT_RED);
  }
