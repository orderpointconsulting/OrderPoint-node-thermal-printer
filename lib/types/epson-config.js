module.exports = {
  ...
  TXT_FONT_C      : Buffer.from([0x1b, 0x4d, 0x02]), // Font type C - for impact printer ESC M
  TXT_FONT_D      : Buffer.from([0x1b, 0x4d, 0x03]), // Font type D - for impact printer ESC M
  TXT_FONT_E      : Buffer.from([0x1b, 0x4d, 0x04]), // Font type E - for impact printer ESC M
  ...
  TXT_BLACK       : Buffer.from([0x1b, 0x72, 0x00]), // Black Color for Font - ESC r
  TXT_RED         : Buffer.from([0x1b, 0x72, 0x01]), // Red Color for Font - ESC r
